...
public class LongIntTreeMapTest {
    ...
    public void testFirstKey() {
        Assert.assertEquals(map.firstKey(), sort[0]);
    }
    ...
    public void testLastKey() {
        Assert.assertEquals(map.lastKey(), sort[sort.length - 1]);
    }
    ...
    public void testKeyIterator() {
        ...
        for ( int i=0; iter.hasNext(); ++i ) {
            ...
            Assert.assertEquals(sort[i], key);
        }
    }
    ...
    public void testSubMap() {
        ...
        for ( i=i1; iter.hasNext() && i <= i2; ++i ) {
            Assert.assertEquals(iter.nextLong(), sort[i]);
        }
